...
>
	...
	<article v-else :class="$style.article" @contextmenu.stop="onContextmenu">
		...
		<div :class="[{ [$style.noteClickToOpen]: prefer.s.noteClickToOpen }]" @click.stop="prefer.s.noteClickToOpen ? noteClickToOpen(appearNote.id) : undefined">
			...
			<MkReactionsViewer v-if="appearNote.reactionAcceptance !== 'likeOnly' && !disableReactionsViewer" style="margin-top: 6px;" :note="appearNote" :maxNumber="16" @mockUpdateMyReaction="emitUpdReaction">
				<template #more>
...
const defaultLike = computed(() => prefer.s.defaultLike);
