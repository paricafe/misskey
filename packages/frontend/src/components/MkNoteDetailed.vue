				...
				<div :class="$style.noteHeaderBody">
					<div>
						...
						<div :class="$style.noteHeaderInfo">
							...
							<span v-if="note.updatedAt" ref="historyMenu" :class="[showingNoteHistoryRef ? $style.active : undefined]" style="margin-right: 0.5em;" :title="i18n.ts.edited" @click="historyMenu"><i class="ti ti-pencil"></i></span>
						</div>
					</div>
