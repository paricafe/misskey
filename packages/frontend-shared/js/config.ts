...
const oauthLanguage = window.document.querySelector<HTMLMetaElement>('meta[name="misskey:oauth:lang"]')?.content;
export const lang = oauthLanguage != null && _LANGS_.some(([code]) => code === oauthLanguage) ? oauthLanguage : localStorage.getItem('lang') ?? 'en-US';
