...
export const MASTODON_4_6_USER_ROUTES: readonly MastodonContractRoute[] = [
	...
	safeArray('GET', '/api/v1/statuses/:id/history', 'public', 'read:statuses', 'StatusEdit[]', '3.5.0'),
	implemented('GET', '/api/v1/statuses/:id/source', 'token', 'read:statuses', 'StatusSource', '3.5.0'),
	safeArray('GET', '/api/v1/statuses/:id/quotes', 'token', 'read:statuses', 'Status[]', '4.6.0'),
	...
	unsupported('POST', '/api/v1/statuses/:id/mute', 'user', 'write:mutes', 'Status'),
	unsupported('POST', '/api/v1/statuses/:id/unmute', 'user', 'write:mutes', 'Status'),
	...
	unsupported('POST', '/api/v1/statuses/:id/translate', 'user', 'read:statuses', 'Translation', '4.0.0'),
	...
	safeArray('GET', '/api/v1/accounts/:id/featured_tags', 'public', 'read:accounts', 'FeaturedTag[]', '3.0.0'),
	safeArray('GET', '/api/v1/accounts/:id/endorsements', 'public', 'read:accounts', 'Account[]', '2.5.0'),
	...
	unsupported('POST', '/api/v1/accounts/:id/pin', 'user', 'write:accounts', 'Relationship'),
	...
	safeArray('GET', '/api/v1/endorsements', 'user', 'read:accounts', 'Account[]', '2.5.0'),
	...
	safeArray('GET', '/api/v1/directory', 'public', undefined, 'Account[]', '3.0.0'),
	implemented('GET', '/api/v1/instance', 'public', undefined, 'Instance'),
	safeArray('GET', '/api/v1/instance/peers', 'public', undefined, 'string[]'),
	...
	safeArray('GET', '/api/v1/instance/activity', 'public', undefined, 'InstanceActivity[]'),
	...
	unsupported('POST', '/api/v1/tags/:id/follow', 'user', 'write:follows', 'Tag', '4.0.0'),
	unsupported('POST', '/api/v1/tags/:id/unfollow', 'user', 'write:follows', 'Tag', '4.0.0'),
	unsupported('POST', '/api/v1/tags/:id/feature', 'user', 'write:accounts', 'Tag', '4.4.0'),
	unsupported('POST', '/api/v1/tags/:id/unfeature', 'user', 'write:accounts', 'Tag', '4.4.0'),
	safeArray('GET', '/api/v1/followed_tags', 'user', 'read:follows', 'Tag[]', '4.0.0'),
	safeArray('GET', '/api/v1/featured_tags', 'user', 'read:accounts', 'FeaturedTag[]', '3.0.0'),
	unsupported('POST', '/api/v1/featured_tags', 'user', 'write:accounts', 'FeaturedTag', '3.0.0', ['name']),
	unsupported('DELETE', '/api/v1/featured_tags/:id', 'user', 'write:accounts', 'Object', '3.0.0'),
	safeArray('GET', '/api/v1/featured_tags/suggestions', 'user', 'read:accounts', 'Tag[]', '3.0.0'),
	safeArray('GET', '/api/v1/announcements', 'user', undefined, 'Announcement[]', '3.1.0'),
	...
	safeArray('GET', '/api/v1/filters', 'user', 'read:filters', 'Filter[]'),
	unsupported('POST', '/api/v1/filters', 'user', 'write:filters', 'Filter', '1.1.0', ['phrase', 'context']),
	notFound('GET', '/api/v1/filters/:id', 'user', 'read:filters', 'Filter'),
	unsupported('PUT', '/api/v1/filters/:id', 'user', 'write:filters', 'Filter'),
	unsupported('DELETE', '/api/v1/filters/:id', 'user', 'write:filters', 'Object'),
	safeArray('GET', '/api/v2/filters', 'user', 'read:filters', 'Filter[]', '4.0.0'),
	unsupported('POST', '/api/v2/filters', 'user', 'write:filters', 'Filter', '4.0.0', ['title', 'context']),
	notFound('GET', '/api/v2/filters/:id', 'user', 'read:filters', 'Filter', '4.0.0'),
	unsupported('PUT', '/api/v2/filters/:id', 'user', 'write:filters', 'Filter', '4.0.0'),
	unsupported('DELETE', '/api/v2/filters/:id', 'user', 'write:filters', 'Object', '4.0.0'),
	safeArray('GET', '/api/v2/filters/:filter_id/keywords', 'user', 'read:filters', 'FilterKeyword[]', '4.0.0'),
	unsupported('POST', '/api/v2/filters/:filter_id/keywords', 'user', 'write:filters', 'FilterKeyword', '4.0.0', ['keyword']),
	notFound('GET', '/api/v2/filters/keywords/:id', 'user', 'read:filters', 'FilterKeyword', '4.0.0'),
	unsupported('PUT', '/api/v2/filters/keywords/:id', 'user', 'write:filters', 'FilterKeyword', '4.0.0', ['keyword']),
	unsupported('DELETE', '/api/v2/filters/keywords/:id', 'user', 'write:filters', 'Object', '4.0.0'),
	safeArray('GET', '/api/v2/filters/:filter_id/statuses', 'user', 'read:filters', 'FilterStatus[]', '4.0.0'),
	unsupported('POST', '/api/v2/filters/:filter_id/statuses', 'user', 'write:filters', 'FilterStatus', '4.0.0', ['status_id']),
	notFound('GET', '/api/v2/filters/statuses/:id', 'user', 'read:filters', 'FilterStatus', '4.0.0'),
	unsupported('DELETE', '/api/v2/filters/statuses/:id', 'user', 'write:filters', 'Object', '4.0.0'),
	safeObject('GET', '/api/v1/markers', 'user', 'read:statuses', 'Markers', '3.0.0'),
	unsupported('POST', '/api/v1/markers', 'user', 'write:statuses', 'Markers', '3.0.0'),
	...
	safeArray('GET', '/api/v1/domain_blocks/preview', 'user', 'read:blocks', 'DomainBlock[]', '4.0.0'),
	safeArray('GET', '/api/v1/domain_blocks', 'user', 'read:blocks', 'DomainBlock[]', '1.4.0'),
	unsupported('POST', '/api/v1/domain_blocks', 'user', 'write:blocks', 'DomainBlock', '1.4.0', ['domain']),
	unsupported('DELETE', '/api/v1/domain_blocks', 'user', 'write:blocks', 'Object', '1.4.0', ['domain']),
