...
export const MASTODON_4_6_USER_ROUTES: readonly MastodonContractRoute[] = [
	...
	implemented('GET', '/api/v1/statuses', 'public', 'read:statuses', 'Status[]', '4.6.0'),
	...
	implemented('GET', '/api/v1/accounts', 'public', 'read:accounts', 'Account[]', '4.6.0'),
	...
	implemented('GET', '/api/v1/accounts/:account_id/collections', 'public', 'read:collections', 'Collections', '4.6.0'),
	implemented('GET', '/api/v1/accounts/:account_id/in_collections', 'user', 'read:collections', 'Collections', '4.6.0'),
	...
	implemented('GET', '/api/v1/notifications/unread_count', 'user', 'read:notifications', 'UnreadCount', '4.3.0'),
	implemented('POST', '/api/v1/notifications/:id/dismiss', 'user', 'write:notifications', 'Object'),
	implemented('GET', '/api/v1/notifications/requests', 'user', 'read:notifications', 'NotificationRequest[]', '4.3.0'),
	implemented('GET', '/api/v1/notifications/requests/:id', 'user', 'read:notifications', 'NotificationRequest', '4.3.0'),
	implemented('GET', '/api/v1/notifications/requests/merged', 'user', 'read:notifications', 'NotificationRequestMerged', '4.3.0'),
	implemented('POST', '/api/v1/notifications/requests/accept', 'user', 'write:notifications', 'Object', '4.3.0'),
	implemented('POST', '/api/v1/notifications/requests/dismiss', 'user', 'write:notifications', 'Object', '4.3.0'),
	implemented('POST', '/api/v1/notifications/requests/:id/accept', 'user', 'write:notifications', 'Object', '4.3.0'),
	implemented('POST', '/api/v1/notifications/requests/:id/dismiss', 'user', 'write:notifications', 'Object', '4.3.0'),
	implemented('GET', '/api/v1/notifications/policy', 'user', 'read:notifications', 'NotificationPolicy', '4.3.0'),
	implemented('PATCH', '/api/v1/notifications/policy', 'user', 'write:notifications', 'NotificationPolicy', '4.3.0'),
	implemented('PUT', '/api/v1/notifications/policy', 'user', 'write:notifications', 'NotificationPolicy', '4.3.0'),
	implemented('GET', '/api/v2/notifications', 'user', 'read:notifications', 'GroupedNotificationsResults', '4.3.0'),
	implemented('GET', '/api/v2/notifications/:group_key', 'user', 'read:notifications', 'GroupedNotificationsResults', '4.3.0'),
	implemented('POST', '/api/v2/notifications/clear', 'user', 'write:notifications', 'Object', '4.3.0'),
	implemented('GET', '/api/v2/notifications/unread_count', 'user', 'read:notifications', 'UnreadCount', '4.3.0'),
	implemented('POST', '/api/v2/notifications/:group_key/dismiss', 'user', 'write:notifications', 'Object', '4.3.0'),
	implemented('GET', '/api/v2/notifications/:group_key/accounts', 'user', 'read:notifications', 'Account[]', '4.3.0'),
	implemented('GET', '/api/v2/notifications/policy', 'user', 'read:notifications', 'NotificationPolicy', '4.3.0'),
	implemented('PATCH', '/api/v2/notifications/policy', 'user', 'write:notifications', 'NotificationPolicy', '4.3.0'),
	implemented('PUT', '/api/v2/notifications/policy', 'user', 'write:notifications', 'NotificationPolicy', '4.3.0'),
	...
	implemented('POST', '/api/v1/push/subscription', 'user', 'push', 'WebPushSubscription', '2.4.0'),
	implemented('GET', '/api/v1/push/subscription', 'user', 'push', 'WebPushSubscription', '2.4.0'),
	implemented('PUT', '/api/v1/push/subscription', 'user', 'push', 'WebPushSubscription', '2.4.0'),
	implemented('DELETE', '/api/v1/push/subscription', 'user', 'push', 'Object', '2.4.0'),
	route('POST', '/api/v1/collections', { auth: 'user', scope: 'write:collections', entity: 'WrappedCollection', behavior: 'implemented', introducedIn: '4.6.0', requiredBody: ['name'] }),
	implemented('GET', '/api/v1/collections/:id', 'public', 'read:collections', 'CollectionWithAccounts', '4.6.0'),
	implemented('PATCH', '/api/v1/collections/:id', 'user', 'write:collections', 'WrappedCollection', '4.6.0'),
	implemented('PUT', '/api/v1/collections/:id', 'user', 'write:collections', 'WrappedCollection', '4.6.0'),
	implemented('DELETE', '/api/v1/collections/:id', 'user', 'write:collections', 'Empty', '4.6.0'),
	route('POST', '/api/v1/collections/:collection_id/items', { auth: 'user', scope: 'write:collections', entity: 'WrappedCollectionItem', behavior: 'implemented', introducedIn: '4.6.0', requiredBody: ['account_id'] }),
	implemented('DELETE', '/api/v1/collections/:collection_id/items/:id', 'user', 'write:collections', 'Empty', '4.6.0'),
	implemented('POST', '/api/v1/collections/:collection_id/items/:id/revoke', 'user', 'write:collections', 'Empty', '4.6.0'),
