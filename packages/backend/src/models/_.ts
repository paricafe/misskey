...
import { MiMastodonCompatEntry } from '@/models/MastodonCompatEntry.js';
...
export type MastodonCompatEntriesRepository = Repository<MiMastodonCompatEntry> & MiRepository<MiMastodonCompatEntry>;
