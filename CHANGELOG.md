...
- Enhance: Add stateful Mastodon compatibility for filters, markers, followed and featured tags, endorsements, collections, conversations, notification groups, notification policies and requests, domain blocks, and status and thread mutes
